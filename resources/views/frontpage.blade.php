                   ...
                   <div class="row">
                      ...
                      <div class="col-md-6">
                         <div class="banner_taital_main">
                            <h1 class="banner_taital">Een heerlijk dagje uit!</h1>
             ...
             <div class="carousel-item">
                <div class="container-fluid">
                   <div class="row">
                      ...
                      <div class="col-lg-3 col-md-6">
                         <div class="coffee_img"><img src="img-2.png"></div>
                         <h3 class="types_text">BEAN VARIETIES</h3>
                         <p class="looking_text">looking at its layout. The point of</p>
                         <div class="read_bt"><a href="#">Read More</a></div>
                      </div>
    ...
    <div class="container">
       <div class="row">
          <div class="col-md-12">
             ...
             <div class="bulit_icon"><img src="public/images/bulit-icon.png"></div>
          </div>
       </div>
